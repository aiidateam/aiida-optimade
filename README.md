...
|-|-|-|-|
| `v1.0 < v2.0` | ![Compatibility for v1.0][AiiDA v1.0] |  [![PyPI pyversions](https://img.shields.io/pypi/pyversions/aiida-optimade)](https://pypi.org/project/aiida-optimade) | ![OPTIMADE SPEC compatibility][OPTIMADE spec v0.18] |
| `v0.18 < v0.20` | ![Compatibility for v3.5][AiiDA v0.18] |  [![PyPI pyversions][Python v3.7-v3.9]](https://pypi.org/project/aiida-optimade/0.18.0/) | ![OPTIMADE SPEC compatibility][OPTIMADE spec v0.18] |
...
[OPTIMADE spec v0.18]: https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/Materials-Consortia/optimade-python-tools/v0.18.0/optimade-version.json
