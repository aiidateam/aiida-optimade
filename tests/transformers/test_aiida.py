...
def test_number_values():
    ...
    assert transform("d = 1.2") == {"d": {"==": 1.2}}
    assert transform("e = .2E7") == {"e": {"==": 2000000.0}}
    assert transform("f = -.2E+7") == {"f": {"==": -2000000.0}}
    assert transform("g = +10.01E-10") == {"g": {"==": 1.001e-09}}
    assert transform("h = 6.03e23") == {"h": {"==": 6.03e23}}
    assert transform("i = .1E1") == {"i": {"==": 1.0}}
    assert transform("j = -.1e1") == {"j": {"==": -1.0}}
    assert transform("k = 1.e-12") == {"k": {"==": 1e-12}}
    assert transform("l = -.1e-12") == {"l": {"==": -1e-13}}
    assert transform("m = 1000000000.E1000000000") == {"m": {"==": float("inf")}}
...
def test_operators():
    ...
    assert transform("_exmpl_cell_volume<100.0") == {"_exmpl_cell_volume": {"<": 100.0}}
