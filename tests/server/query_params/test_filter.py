...
if TYPE_CHECKING:
    ...
    from ..conftest import CheckErrorResponse, CheckResponse


@pytest.mark.skip(
    "Un-skip when a fix for optimade-python-tools issue #102 is in place."
)
def test_custom_field(check_response: CheckResponse) -> None:
...
def test_id(check_response: CheckResponse, get_valid_id: str) -> None:
...
def test_geq(check_response: CheckResponse) -> None:
    request = "/structures?filter=nelements>=18"
    expected_uuids = ["b6175807-826a-459f-8a5a-7bff75ff1d36"]
    check_response(request, expected_uuids)


def test_gt(check_response: CheckResponse) -> None:
    request = "/structures?filter=nelements>17"
    expected_uuids = ["b6175807-826a-459f-8a5a-7bff75ff1d36"]
    check_response(request, expected_uuids)


def test_gt_none(check_response: CheckResponse) -> None:
    request = "/structures?filter=nelements>18"
    expected_uuids: list[str] = []
    check_response(request, expected_uuids)


def test_rhs_statements(check_response: CheckResponse, get_valid_id: str) -> None:
...
def test_list_has(check_response: CheckResponse) -> None:
...
def test_page_limit(check_response: CheckResponse) -> None:
...
def test_list_has_all(check_response: CheckResponse) -> None:
    request = '/structures?filter=elements HAS ALL "Ge","Na","Al","Cl","O"'
    expected_uuids = ["254947de-54c8-4cdb-afc5-1cee237f9f98"]
    check_response(request, expected_uuids)


def test_list_has_any(check_response: CheckResponse) -> None:
    elements = '"La","Ba"'
...
def test_list_length_basic(check_response: CheckResponse) -> None:
    request = "/structures?filter=elements LENGTH 18"
    expected_uuids = ["b6175807-826a-459f-8a5a-7bff75ff1d36"]
    check_response(request, expected_uuids)


def test_list_length_operators(check_response: CheckResponse) -> None:
...
def test_list_length_bad_operators(check_error_response: CheckErrorResponse) -> None:
...
def test_list_has_only(check_error_response: CheckErrorResponse) -> None:
...
def test_list_correlated(check_error_response: CheckErrorResponse) -> None:
...
def test_saved_extras_is_known(check_response: CheckResponse) -> None:
...
def test_node_columns_is_known(check_response: CheckResponse) -> None:
    from optimade.server.config import CONFIG, SupportedBackend
...
def test_node_column_fields(check_response: CheckResponse, get_valid_id: str) -> None:
    request = f'/structures?filter=id="{get_valid_id}"'
    expected_ids = [str(get_valid_id)]
    check_response(request, expected_ids, expect_id=True)


def test_saved_extras_fields(check_response: CheckResponse) -> None:
...
def test_string_contains(check_response: CheckResponse) -> None:
...
def test_string_start(check_response: CheckResponse) -> None:
...
def test_string_end(check_response: CheckResponse) -> None:
...
def test_list_has_and(check_response: CheckResponse) -> None:
    request = '/structures?filter=elements HAS "Na" AND nelements=18'
    expected_uuids = ["b6175807-826a-459f-8a5a-7bff75ff1d36"]
    check_response(request, expected_uuids)


def test_not_or_and_precedence(check_response: CheckResponse) -> None:
...
def test_brackets(check_response: CheckResponse) -> None:
