...
from .modified_jsonapi import Error, Success, Warnings
from .jsonapi import Failure, Link
...
class Implementation(BaseModel):
    ...
    version: Optional[str] = Schema(..., description='version string of the current implementation')
